...
<div class="contacts" >
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            ...
                            <br> <br>
                            по адресу: <?php the_field('addr', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="contacts__map">
                            <?php echo do_shortcode( '[yamap center="55.7428,37.6274" height="100%" controls="" zoom="12" type="yandex#map" scrollzoom="0" mobiledrag="0"][/yamap]' ) ?>
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    // do_action( 'my_hook', 'dear customer', 'Andrew');
